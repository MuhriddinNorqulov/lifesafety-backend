...
class StudentResultAdmin(admin.ModelAdmin):
    list_display = [
        'email', 'first_name', 'last_name', 'group', 'exam_item', 'attempt', 'ball', 'date_created'
    ]
    list_display_links = list_display
    ...
    # @admin.display
    # def semester(self, obj):
    #     return obj.get_exam_semester()
    #     # return obj.exam_item.name
...
class StudentWrongAnswerAdmin(admin.ModelAdmin):
    list_display = [
        'email', 'first_name', 'last_name', 'group', 'exam_item', 'attempt', 'variant'
    ]
    list_display_links = list_display
